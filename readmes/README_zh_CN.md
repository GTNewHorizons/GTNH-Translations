<!-- This is just a template, and you can freely design it. -->
...
## 汉化使用方式
1、找到[Releases](https://github.com/GTNewHorizons/GTNH-Translations/releases)内对应版本
...
汉化相关的反馈与建议请在本仓库提交issue（请勿直接提交到GTNH主仓库），也可以在[汉化包仓库](https://github.com/Kiwi233/Translation-of-GTNH)、[PT项目](https://paratranz.cn/projects/4964/issues)，以及QQ群、Discord`Chinese Translation`频道提交。
...
请到[PT项目](https://paratranz.cn/projects/4964)中提交申请，完成随机条目翻译即可参与汉化项目。
